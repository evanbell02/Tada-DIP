...
class CBCT:
    ...
    def __init__(self, num_views, num_rows, num_cols, sod=1000.0, sdd=1500.0, device='cpu', angles=None):
        ...
        self.proj.leapct.set_conebeam(num_views, num_rows, num_cols, pixelHeight, pixelWidth, centerRow, centerCol, phis, sod, sdd)
